	...
	var Utils = (function () {
	  ...
	  _createClass(Utils, null, [{
	    ...
	    value: function stripPunc(text) {
	      ...
	      // debugger
	      return this.removeStopWords(c.removeInterpunctuation().clean().removeWords(_textMiner2['default'].STOPWORDS.EN).documents[0]);
	    }
	    ...
	    key: 'removeStopWords',
	    value: function removeStopWords(text) {
	      var x;
	      var y;
	      var word;
	      var stop_word;
